...
public class HashFunction {
     ...
     * @return
     */
    public static int JSHash(byte[] str, int len) {
        int hash = 1315423911;
        for (int i = 0; i < len; i++) {
     ...
     * @return
     */
    public static int BKDR(byte[] str, int len) {
     ...
     * @return
     */
    public static int DJBHash(byte[] str, int len) {
        int hash = 5381;
        for (int i = 0; i < len; i++) {
            hash += (hash << 5) + (str[i]);
        }
     ...
     * @return
     */
    public static int DEKHash(byte[] str, int len) {
        int hash = 1315423911;
        for (int i = 0; i < len; i++) {
     ...
     * @return
     */
    public static int APHash(byte[] str, int len) {
        int hash = 0;
        for (int i = 0; i < len; i++) {
            if ((i & 1) == 0) {
     ...
     * @return
     */
    public static int CRC32(byte[] str, int len) {
     ...
     * @return
     */
    public static int SDBM(byte[] str, int len) {
        int hash = 0;
        for (int i = 0; i < len; i++) {
     ...
     * @return
     */
    public static int OCaml(byte[] str, int len) {
        int hash = 0;
        for (int i = 0; i < len; i++) {
            hash = hash * 19 + str[i];
        }
     ...
     * @return
     */
    public static int SML(byte[] str, int len) {
        int hash = 0;
        for (int i = 0; i < len; i++) {
     ...
     * @return
     */
    public static int STL(byte[] str, int len) {
        int hash = 0;
        for (int i = 0; i < len; i++) {
            hash = 5 * hash + str[i];
        }
     ...
     * @return
     */
    public static int FNV32(byte[] str, int len) {
        int hash = 0;
        for (int i = 0; i < len; i++) {
            hash *= 0x01000193;
     ...
     * @return
     */
    public static int PJWHash(byte[] str, int len) {
     ...
     * @return
     */
    public static int RS(byte[] str, int len) {
        int b = 378551;
        int a = 63689;
        int hash = 0;
        for (int i = 0; i < len; i++) {
     ...
     * @return
     */
    public static int JS(byte[] str, int len) {
     ...
     * @return
     */
    public static int PJW(byte[] str, int len) {
     ...
     * @return
     */
    public static int SDBW(byte[] str, int len) {
        int hash = 0;
        for (int i = 0; i < len; i++) {
            hash = str[i] + (hash << 6) + (hash << 16) - hash;
        }
     ...
     * @return
     */
    public static int DJB(byte[] str, int len) {
        int hash = 5381;
        for (int i = 0; i < len; i++) {
     ...
     * @return
     */
    public static int RSHash(byte[] str, int len) {
        int b = 378551;
        int a = 63689;
        int hash = 0;
        for (int i = 0; i < len; i++) {
     ...
     * @return
     */
    public static int BOB1(byte[] str, int len) {
        int a;
        int b;
        int c;
        int initval = 2;
        ...
        while (len >= 12) {
            ...
            b = temp[1];
            c = temp[2];
            str = intToByteArray(byteArrayToInt(str) + 12);
            len -= 12;
        }
     ...
     * @return
     */
    public static int BOB2(byte[] str, int len) {
        int a;
        int b;
        int c;
        int initval = 31;
     ...
     * @return
     */
    public static int BOB3(byte[] str, int len) {
        int a;
        int b;
        int c;
        int initval = 73;
     ...
     * @return
     */
    public static int BOB4(byte[] str, int len) {
        int a;
        int b;
        int c;
        int initval = 127;
